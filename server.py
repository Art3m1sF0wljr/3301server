...
class Server(threading.Thread):
    def __init__(self, csock, address, clientcounter):
        ...
        self.logger = Logger("/home/pi/program/3301/logs/clientlog-%d-%d.txt" % (int(time.time()), clientcounter))
        self.csock = csock
    ...
    def handle_line(self, line):
        ...
        if cmd == "rand": # b
            ...
            return self.send_file("/home/pi/program/3301/quine.py")
            
        elif cmd == "base29": # d
            return self.handle_base29(parts)
            
        elif cmd == "code": # e
            return self.send_file("/home/pi/program/3301/server.py")
            
        elif cmd == "koan": # f
            return self.send_file("/home/pi/program/3301/koan.txt")
            ...
            return self.send_file("/home/pi/program/3301/help.txt")
...
def main():
    logger = Logger("/home/pi/program/3301/logs/mainlog.txt")
